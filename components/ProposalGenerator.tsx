              ...
              <div className="text-center mt-48 flex flex-col items-center flex-1">
                  ...
                  <div className="text-3xl text-gray-700 font-medium mb-4 flex items-center justify-center">
                      ...
                      {!isThumbnail ? (
                        ...
                        <div className="text-4xl font-black border-b-4 border-gray-900 pb-2 mx-4 text-center w-64 text-gray-900 truncate px-2 leading-none h-[60px] flex items-center justify-center">
                            ...
                            <div className="w-full aspect-[210/297] relative overflow-hidden bg-gray-100 border-b border-gray-200">
                                <div 
                                    ...
                                    style={{ 
                                        width: '210mm', 
                                        height: '297mm', 
                                        transform: 'translateX(-50%) scale(0.312)', 
                                        pointerEvents: 'none',
                                        userSelect: 'none'
                                    }}
                                >
